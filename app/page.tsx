...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      >
        <Image src="/gitmystat.png" alt="Logo" width={200} height={200} />
        <h1 className="text-center text-6xl font-bold">gitMyStat!</h1>
        <p className="text-accent text-center text-xl font-medium">
          Turn your GitHub activity into sleek stats and cool visuals
        </p>
      </section>
      <section className="dark:bg-dark-background dark:border-dark-border bg-light-background border-light-border flex min-h-screen w-full flex-col justify-center gap-32 border-t-2 border-solid px-24 py-16 lg:flex-row lg:px-48">
        <div className="flex flex-col items-start gap-12 lg:items-start lg:justify-center">
          <div className="flex flex-col items-start gap-3">
            ...
            <p className="dark:text-dark-accent text-light-accent max-w-[70%] text-xl font-medium">
        ...
        <div className="flex flex-col items-start gap-12 lg:flex-col-reverse lg:items-center lg:justify-center">
          <div className="flex flex-col items-start gap-3 lg:items-end">
            ...
            <p className="dark:text-dark-accent text-light-accent max-w-[70%] text-left text-xl font-medium lg:text-right">
              My mission is to modernize the README visuals of github with
              stunning statistics of other{"'"}s work and progress.
            </p>
          </div>
          <picture className="flex w-full justify-end">
            <source
      ...
      <section className="dark:bg-dino-background dark:border-dino-border bg-dino-light-background border-dino-light-border flex min-h-screen w-full flex-col justify-center gap-32 border-t-2 border-solid px-24 py-16 lg:flex-row lg:px-48">
        <div className="flex flex-col items-start gap-12 lg:flex-col-reverse lg:items-center lg:justify-center">
          <div className="mx-auto flex flex-col items-start gap-3">
            <h2 className="dark:text-dino-color text-dino-light-color w-full text-center text-4xl font-bold">
              Awesome flavors
            </h2>
            <p className="dark:text-dino-accent text-dino-light-accent mx-auto max-w-[70%] text-center text-xl font-medium">
      ...
      <section className="dark:bg-catppuccin-border dark:border-catppuccin-background bg-catppuccin-light-background border-catppuccin-light-border flex min-h-screen w-full flex-col justify-center gap-32 border-t-2 border-solid px-24 py-16 lg:flex-row lg:px-48">
        <div className="flex flex-col items-start gap-12 lg:flex-col-reverse lg:items-start lg:justify-center">
          <div className="flex flex-col items-start gap-3">
            ...
            <p className="dark:text-catppuccin-accent text-catppuccin-light-accent max-w-[70%] text-xl font-medium">
        ...
        <div className="flex flex-col items-start gap-12 lg:items-end lg:justify-center">
          <div className="flex flex-col items-start gap-3 lg:items-end">
            ...
            <p className="dark:text-catppuccin-accent text-catppuccin-light-accent max-w-[70%] text-left text-xl font-medium lg:text-right">
      ...
      <section className="dark:bg-cyred-background dark:border-cyred-border bg-cyred-light-background border-cyred-light-border relative flex min-h-screen w-full flex-col items-center justify-evenly gap-32 border-t-2 border-solid px-24 py-16 lg:px-48">
        <div className="flex flex-col items-start gap-12 lg:items-center lg:justify-center">
          <div className="mx-auto flex flex-col items-start gap-3">
            <h2 className="dark:text-cyred-color text-cyred-light-color w-full text-center text-4xl font-bold">
              AHHHHH *burning*
            </h2>
            <p className="dark:text-cyred-accent text-cyred-light-accent mx-auto max-w-[70%] text-center text-xl font-medium">
      ...
      <section className="dark:bg-gold-background dark:border-gold-border bg-gold-light-background border-gold-light-border flex min-h-screen w-full flex-col justify-center gap-48 border-t-2 border-solid px-24 py-8 lg:px-48">
        <div className="flex flex-col items-start gap-12 lg:flex-row lg:items-center lg:justify-between">
          <div className="flex max-w-[60%] flex-col items-start gap-3">
            ...
            <p className="dark:text-gold-accent text-gold-light-accent max-w-[70%] text-xl font-medium">
      ...
      <section className="dark:bg-dark-background dark:border-dark-border bg-light-background border-light-border flex min-h-screen w-full flex-col items-start justify-start gap-12 border-t-2 border-solid px-24 py-16 lg:px-48">
        <h2 className="text-center text-5xl font-bold">Themes</h2>
        <div className="grid grid-cols-3 rounded-xl w-full gap-12 ">
          {Object.keys(Themes).map((theme, i) => {
            return (
              <div className="flex flex-col items-center justify-center gap-4" key={i}>
                <picture className="bg-[#fefefe] rounded-[2.5rem] p-3 dark:bg-[#10151b] self-center">
            <source
              srcSet={`/repo?username=rahuletto&repo=gitMyStat&theme=${theme}`}
              media="(prefers-color-scheme: dark)"
            />
            <Image
            className="mx-auto"
              ...
              height={170}
              loading="lazy"
              src={`/repo?username=rahuletto&repo=gitMyStat&theme=${theme}`}
              alt="GitHub"
            />
          </picture>
          <code style={{background: Themes[theme].background, color: Themes[theme].color }} className="font-bold rounded-xl px-4 py-2">{theme}</code>
              </div>
            );
          })}
        </div>
