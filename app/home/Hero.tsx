  ...
  return (
    <>
        ...
        <section
          data-theme="default"
          id="features"
          className="dark:bg-dark-background dark:border-dark-border bg-light-background border-light-border flex min-h-screen w-full flex-col justify-center gap-32 border-t-2 border-solid px-24 py-16 lg:flex-row lg:px-48"
        >
        ...
        <section
          data-theme="dino"
          className="dark:bg-dino-background dark:border-dino-border bg-dino-light-background border-dino-light-border flex min-h-screen w-full flex-col justify-center gap-32 border-t-2 border-solid px-24 py-16 lg:flex-row lg:px-48"
        >
          <div className="flex flex-col items-start justify-start gap-12 lg:flex-col-reverse lg:items-center lg:justify-center">
            <div className="mx-auto flex flex-col items-start gap-3">
              ...
              <p className="dark:text-dino-accent text-dino-light-accent max-w-[70%] text-xl font-medium lg:mx-auto lg:text-center">
        ...
        <section
          ...
          className="dark:bg-catppuccin-border dark:border-catppuccin-background bg-catppuccin-light-background border-catppuccin-light-border flex min-h-screen w-full flex-col justify-center gap-32 border-t-2 border-solid px-24 py-16 lg:flex-row lg:px-48"
        >
        ...
        <section
          data-theme="cyred"
          className="dark:bg-cyred-background dark:border-cyred-border bg-cyred-light-background border-cyred-light-border relative flex min-h-screen w-full flex-col items-start justify-evenly gap-32 border-t-2 border-solid px-24 py-16 lg:items-center lg:px-48"
        >
          <div className="flex flex-col items-start gap-12 lg:items-center lg:justify-center">
            <div className="mx-auto flex flex-col items-start gap-3">
              ...
              <p className="dark:text-cyred-accent text-cyred-light-accent max-w-[70%] text-xl font-medium lg:mx-auto lg:text-center">
        ...
        <section
          data-theme="gold"
          className="dark:bg-gold-background dark:border-gold-border bg-gold-light-background border-gold-light-border flex min-h-screen w-full flex-col justify-center gap-48 border-t-2 border-solid px-24 py-8 lg:px-48"
        >
